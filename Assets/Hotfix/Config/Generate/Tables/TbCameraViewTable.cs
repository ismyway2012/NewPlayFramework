...
{
    public partial class TbCameraViewTable : BaseDataTable<Tables.CameraViewTable>
    {
        private readonly System.Func<System.Threading.Tasks.Task<JSONNode>> _loadFunc;        
        public TbCameraViewTable(System.Func<System.Threading.Tasks.Task<JSONNode>> loadFunc)
        {
            _loadFunc = loadFunc;
        }
        public override async System.Threading.Tasks.Task LoadAsync()
        {
            ...
            {
                Tables.CameraViewTable _v;
                { if(!_ele.IsObject) { throw new SerializationException(); }  _v = Tables.CameraViewTable.DeserializeCameraViewTable(_ele);  }
                DataList.Add(_v);
