...
{
    public partial class TbColorTable : BaseDataTable<Tables.ColorTable>
    {
        private readonly System.Func<System.Threading.Tasks.Task<JSONNode>> _loadFunc;        
        public TbColorTable(System.Func<System.Threading.Tasks.Task<JSONNode>> loadFunc)
        {
            _loadFunc = loadFunc;
        }
        public override async System.Threading.Tasks.Task LoadAsync()
        {
            ...
            {
                Tables.ColorTable _v;
                { if(!_ele.IsObject) { throw new SerializationException(); }  _v = Tables.ColorTable.DeserializeColorTable(_ele);  }
                DataList.Add(_v);
