...
public static class SoundExtension
{
    ...
    /// <returns></returns>
    public static UniTask<int> PlayBGM(this SoundComponent soundCom, string name)
    {
    ...
    /// <param name="name"></param>
    /// <returns></returns>
    public static UniTask<int> PlaySound(this SoundComponent soundCom, string name, string group, Vector3 worldPos, bool isLoop = false)
    {
    ...
    public static UniTask<int> PlayEffect(this SoundComponent soundCom, string name, bool isLoop = false)
    {
