...
public static class UtilityBuiltin
{
    ...
    public static class AssetsPath
    {
        ...
        {
            return Utility.Text.Format("Assets/Bundles/DataTable/{0}.{1}", name, useBytes ? "bytes": "txt");
        }

        public static string GetSoundPath(string name)
        {
            return Utility.Text.Format("Assets/Bundles/Audio/{0}", name);
        }

        public static string GetScenePath(string name)
        {
            return Utility.Text.Format("Assets/Bundles/Scenes/{0}.unity", name);
        }
        public static string GetEntityPath(string name)
        {
            return Utility.Text.Format("Assets/Bundles/Prefabs/Entity/{0}.prefab", name);
        }

        public static string GetUIFormPath(string v)
        {
            return Utility.Text.Format("{0}{1}.prefab", GetUIPrefabPath(), v);
        }

        public static string GetUIPrefabPath()
        {
            return "Assets/Bundles/Prefabs/UI/";
        }

        public static string GetTexturePath(string fileName)
        {
            return Utility.Text.Format("Assets/Bundles/Textures/{0}", fileName);
        }
        public static string GetSpritesPath(string fileName)
        {
            return Utility.Text.Format("Assets/Bundles/Sprites/{0}", fileName);
        }
        public static string GetConfigPath(string v, bool useBytes)
        {
            return Utility.Text.Format("Assets/Bundles/Config/{0}.{1}", v, useBytes ? "bytes" : "txt");
        }
        public static string GetScriptableConfigPath(string v)
        {
            return Utility.Text.Format("Assets/Bundles/ScriptableAssets/{0}.asset", v);
        }

        public static string GetPrefab(string v)
        {
            return Utility.Text.Format("Assets/Bundles/Prefabs/{0}.prefab", v);
        }

        public static string GetLanguagePath(string v, bool useBytes)
        {
            return Utility.Text.Format("Assets/Bundles/Language/{0}.{1}", v, useBytes ? "bytes" : "json");
        }
        public static string GetMaterialPath(string v)
        {
            return Utility.Text.Format("Assets/Bundles/Material/{0}.mat", v);
        }

        public static string GetHotfixDll(string dllName)
        {
            return Utility.Text.Format("Assets/Bundles/HotfixDlls/{0}.bytes", dllName);
        }
