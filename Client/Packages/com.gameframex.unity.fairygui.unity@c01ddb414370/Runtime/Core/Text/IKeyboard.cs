namespace FairyGUI
{
    ...
    public interface IKeyboard
    {
        ...
        void Open(string text, int keyboardType, bool autocorrection, bool multiline, bool secure, bool alert, bool hideInput, string textPlaceholder, int characterLimit);
