...
{
    public partial class TbCombatUnitTable : BaseDataTable<Tables.CombatUnitTable>
    {
        private readonly System.Func<System.Threading.Tasks.Task<JSONNode>> _loadFunc;        
        public TbCombatUnitTable(System.Func<System.Threading.Tasks.Task<JSONNode>> loadFunc)
        {
            _loadFunc = loadFunc;
        }
        public override async System.Threading.Tasks.Task LoadAsync()
        {
            ...
            {
                Tables.CombatUnitTable _v;
                { if(!_ele.IsObject) { throw new SerializationException(); }  _v = Tables.CombatUnitTable.DeserializeCombatUnitTable(_ele);  }
                DataList.Add(_v);
