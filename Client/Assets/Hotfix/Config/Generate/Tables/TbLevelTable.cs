...
{
    public partial class TbLevelTable : BaseDataTable<Tables.LevelTable>
    {
        private readonly System.Func<System.Threading.Tasks.Task<JSONNode>> _loadFunc;        
        public TbLevelTable(System.Func<System.Threading.Tasks.Task<JSONNode>> loadFunc)
        {
            _loadFunc = loadFunc;
        }
        public override async System.Threading.Tasks.Task LoadAsync()
        {
            ...
            {
                Tables.LevelTable _v;
                { if(!_ele.IsObject) { throw new SerializationException(); }  _v = Tables.LevelTable.DeserializeLevelTable(_ele);  }
                DataList.Add(_v);
