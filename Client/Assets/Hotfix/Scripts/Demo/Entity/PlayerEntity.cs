...
public class PlayerEntity : CombatUnitEntity
{
    ...
    public bool Ctrlable
    {
        ...
        {
            mCtrlable = value;
            GF.StaticUI.Joystick.activated = mCtrlable;
        }
    }
    ...
    Vector3[] m_SmoothHandIkPoints;//˫��IK Points
    ...
    protected override void OnShow(object userData)
    {
        ...
        GF.StaticUI.Joystick.onTouchUp.AddListener(OnJoystickUp);
    }
    protected override void OnHide(bool isShutdown, object userData)
    {
        GF.StaticUI.Joystick.onTouchUp.RemoveListener(OnJoystickUp);
    ...
    protected override void OnUpdate(float elapseSeconds, float realElapseSeconds)
    {
        ...
        Move(elapseSeconds);//�ƶ�
        AttackLogicUpdate(elapseSeconds);
        //Jump(elapseSeconds);//��Ծ
    }
    ...
    private void Move(float elapseSeconds)
    {
        ...
        float movePower = Mathf.Sqrt(horizontal * horizontal + vertical * vertical);
        m_Animator.SetFloat(ANIM_MOVE_KEY, movePower);
        joystickForward.Set(horizontal, 0, vertical);
