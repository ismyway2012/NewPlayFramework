...
namespace NewPlay.ArcadeIdle
{
    ...
    public class MonsterSpawnerNew : MonoBehaviour
    {
        ...
        private bool SpawnOne()
        {
            ...
            var go = ObjectPooler.GetPooledGameObject();
            if (go == null)
            {
                return false;
            }
        ...
        {
            private MonsterSpawnerNew spawner;

            public void Attach(MonsterSpawnerNew owner)
            {
                spawner = owner;
            }
